...
\abstract{%
  ...
  that of short columns. Therefore, the surface area of the
  mobilised mass that interacts with the surrounding fluid in tall columns is significantly
  ...
  thereby altering the deposit morphology. It is observed that
  the vortices result in the formation of heaps that significantly affects
  ...
  The collapse behaviour is analysed for different slope angles: 0\si{\degree}, 2.5\si{\degree}, 5\si{\degree} and 7.5\si{\degree}.}
%
\maketitle
%
...
substrate properties, grain size, packing density, and shape of the granular
...
\Cref{fig:KEy_a6_slope} shows that 
...
\begin{figure}[!tbph]
\centering
\includegraphics[width=0.95\linewidth]{figs/KEy_a6_slope}
